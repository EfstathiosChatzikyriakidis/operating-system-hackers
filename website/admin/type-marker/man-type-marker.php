  ...
  <body>
    <table cellpadding="30" cellspacing="0" border="0" class="hundred">
      <tbody>
        <tr valign="top">
          <td class="side_box">
            <b>- <?php echo do_html_link (FILE_MAN_TYPE_LIST, clean_for_display ($admin_op_man_type_text)); ?></b>
            <br>
            <b>- <?php echo do_html_link (FILE_MAN_MARKER_LIST, clean_for_display ($admin_op_man_marker_text)); ?></b>
          </td>
        </tr>
      </tbody>
    </table>
