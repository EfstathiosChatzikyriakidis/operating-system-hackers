          ...
          <td class="side_box" valign="top">
            <table cellspacing="0" cellpadding="0" border="0">
              <tbody>
                ...
                <tr>
                  <td><b><?php echo clean_for_display ($navigate_goto_text); ?>&nbsp;[ <?php echo do_html_link (FILE_MAN_TYPE_LIST, clean_for_display ($navigate_list_text)); ?> | <?php echo do_html_link ('javascript: history.go(-1);', clean_for_display ($navigate_back_text)); ?> ]</b></td>
                </tr>
              </tbody>
            </table>
          </td>
