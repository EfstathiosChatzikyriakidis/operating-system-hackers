    ...
    <script type="text/javascript">
      ...
      function init_google_map () {
        if (GBrowserIsCompatible ()) {
          ...
          map.setCenter (new GLatLng (<?php echo clean_for_display ($mdata['lat']); ?>, <?php echo clean_for_display ($mdata['lng']); ?>), showZoomLevel);
          map.setUIToDefault ();
                ...
                <tr>
                  <td>
                    <form method="post" name="upd_marker_form" action="<?php echo FILE_UPD_MARKER_PROC; ?>">
                            ...
                            <td class="fieldset">
                              <table cellpadding="0" cellspacing="0" border="0" class="hundred">
                                <tbody>
                                              ...
                                              <table cellpadding="0" cellspacing="0" border="0">
                                                <tbody>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td><?php echo select_type (clean_user_data ($mdata['tid']), "marker_type", clean_for_display ($select_type_default_choose), 'width: 200px;'); ?></td>
                                                  </tr>
                                                  <tr>
                                                    <td colspan="2"><?php echo space (1, 4); ?></td>
                                                  </tr>
                                                      ...
                                                      <table cellpadding="0" cellspacing="0" border="0">
                                                        <tbody>
                                                          <tr>
                                                            ...
                                                            <td><?php echo input_text ('marker_url', 'width: 150px;', clean_for_display ($mdata['url'])); ?></td>
                                                          </tr>
                                                        </tbody>
                                                      </table>
                                                    </td>
                                                  ...
                                                  <tr>
                                                    <td class="nowrap"><?php echo clean_for_display ($admin_upd_marker_form_active); ?></td>
                                                    <td><?php echo select_boolean ('marker_active', 'width: 200px;', clean_for_display ($mdata['active'])); ?></td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                            </td>
                                  ...
                                  <tr>
                                    <td align="center"><i><?php echo clean_for_display ($admin_upd_marker_form_map); ?></i></td>
                                  </tr>
                                  <tr>
                                      ...
                                      <table cellpadding="0" cellspacing="0" border="0">
                                        <tbody>
                                          <tr>
                                            ...
                                            <td style="padding-left: 15px;"><?php echo do_html_link ("#", do_html_img ('../../'.DIR_GRAPHICS.'/submit.png'), '', '', 'onclick="showAddress(document.upd_marker_form.search_address.value);"'); ?></td>
                                          </tr>
                                        </tbody>
                                      </table>
                                    </td>
                                  ...
                                  <tr>
                                    <td><?php echo input_textarea ('marker_text', 'width: 100%; height: 400px;', pretty_for_display ($mdata['text'])); ?></td>
                                  </tr>
                                  <tr>
                                    <td><?php echo space (1, 15); ?></td>
                                  </tr>
                                  <tr>
                                    <td align="right">
                                      <?php
                                        ...
                                        echo space (10, 1);
                                        echo do_html_link (FILE_UPD_MARKER_FORM.'?mid='.$mid, do_html_img ('../../'.DIR_GRAPHICS.'/clear.png'));
                                      ?>
                                    </td>
                                  </tr>
                                </tbody>
                      ...
                      <input type="hidden" name="marker_iemail" value="<?php echo clean_for_display ($mdata['email']) ?>">
                    </form>
                  </td>
                </tr>
              </tbody>
