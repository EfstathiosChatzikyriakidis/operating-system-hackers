    ...
    <script type="text/javascript">
      ...
      function handleLocation (response) {
        if (!response || response.Status.code != 200) {
          document.register_add_marker_form.marker_lat.value  = "";
          document.register_add_marker_form.marker_lng.value  = "";

          alert ("<?php echo clean_for_display ($gmap_error_place); ?>");
        }
        else {
          var location = response.name.split (",");
          document.register_add_marker_form.marker_lat.value  = location[0];
          document.register_add_marker_form.marker_lng.value  = location[1];
        }
      }
          ...
          <td class="side_box" valign="top">
            <table cellspacing="0" cellpadding="0" border="0" class="hundred">
              <tbody>
                ...
                <tr>
                  <td><b><?php echo clean_for_display ($register_add_marker_form_title); ?></b></td>
                </tr>
                <tr>
                  <td><?php echo space (1, 15); ?></td>
                </tr>
                <tr>
                  <td>
                    <form method="post" name="register_add_marker_form" action="<?php echo FILE_REGISTER_PROC; ?>">
                            ...
                            <td class="fieldset">
                              <table cellpadding="0" cellspacing="0" border="0" class="hundred">
                                <tbody>
                                          ...
                                          <tr>
                                            <td width="1" valign="top">
                                              <table cellpadding="0" cellspacing="0" border="0">
                                                <tbody>
                                                  <tr>
                                                    <td class="nowrap"><?php echo clean_for_display ($register_add_marker_form_name); ?></td>
                                                  ...
                                                  <tr>
                                                    <td class="nowrap"><?php echo clean_for_display ($register_add_marker_form_type); ?></td>
                                                  ...
                                                  <tr>
                                                    <td class="nowrap"><?php echo clean_for_display ($register_add_marker_form_url); ?></td>
                                                    <td>
                                                      <table cellpadding="0" cellspacing="0" border="0">
                                                        <tbody>
                                                          <tr>
                                                  ...
                                                  <tr>
                                                    <td class="nowrap"><?php echo clean_for_display ($register_add_marker_form_email); ?></td>
                                            ...
                                            <td width="1" valign="top">
                                              <table cellpadding="0" cellspacing="0" border="0">
                                                <tbody>
                                                  <tr>
                                                    <td class="nowrap"><?php echo clean_for_display ($register_add_marker_form_addr); ?></td>
                                                  ...
                                                  <tr>
                                                    <td class="nowrap"><?php echo clean_for_display ($register_add_marker_form_lat); ?></td>
                                                  ...
                                                  <tr>
                                                    <td class="nowrap"><?php echo clean_for_display ($register_add_marker_form_lng); ?></td>
                                  ...
                                  <tr>
                                    <td><?php echo clean_for_display ($register_add_marker_form_loc); ?></td>
                                  </tr>
                                  <tr>
                                    <td><?php echo space (1, 8); ?></td>
                                  </tr>
                                  <tr>
                                    <td align="center"><i><?php echo clean_for_display ($register_add_marker_form_map); ?></i></td>
                                  </tr>
                                  <tr>
                                      ...
                                      <table cellpadding="0" cellspacing="0" border="0">
                                        <tbody>
                                          <tr>
                                            ...
                                            <td style="padding-left: 15px;"><?php echo do_html_link ("#", do_html_img (DIR_GRAPHICS.'/submit.png'), '', '', 'onclick="showAddress(document.register_add_marker_form.search_address.value);"'); ?></td>
                                          </tr>
                                        </tbody>
                                      </table>
                                    </td>
                                  ...
                                  <tr>
                                    <td><?php echo clean_for_display ($register_add_marker_form_text); ?></td>
                                  </tr>
                                  <tr>
                                    <td><?php echo space (1, 8); ?></td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td align="right">
                                      <?php
                                        ...
                                        echo space (10, 1);
                                        echo do_html_link (FILE_REGISTER_FORM, do_html_img (DIR_GRAPHICS.'/clear.png'));
                                      ?>
                                    </td>
                                  </tr>
                                </tbody>
